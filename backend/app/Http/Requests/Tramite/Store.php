...
use App\Rules\{RelacionadoConTipoTramite, DocumentosNecesariosSegunTipoTramite, ExisteTipoTramiteParaEstablecimiento};
...
class Store extends FormRequest {
    ...
    public function rules() {
        ...
        return [
			...
			'tipo_tramite_id' => ['required', 'integer', 'exists:tipo_tramites,id', new ExisteTipoTramiteParaEstablecimiento($this->establecimiento_id)],
